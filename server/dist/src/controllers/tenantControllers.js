...
const getTenantProperties = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const propertiesWithFormattedLocation = yield Promise.all(properties.map((property) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const [longitude, latitude] = (_b = geoJSON.coordinates) !== null && _b !== void 0 ? _b : [];
...
const addFavoriteProperty = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existingFavorites = (_a = tenant === null || tenant === void 0 ? void 0 : tenant.favorites) !== null && _a !== void 0 ? _a : [];
