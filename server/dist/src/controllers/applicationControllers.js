...
exports.updateApplicationStatus = exports.createApplication = exports.getApplications = void 0;
...
const getApplications = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const formattedApplications = applications.map((app) => __awaiter(void 0, void 0, void 0, function* () {
